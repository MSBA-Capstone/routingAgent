AGENT_PROMPTS = {
    ...
    "route_sanity_check": """
        ...
        When done, include "Final Answer: [your conclusion]"
        """,
        "utility_focused_itinerary": """
        You are an AI assistant that creates travel itineraries focused on utility.
        The user will provide a starting location, a destination, number of days as well as maximum number of hours driving per day.
        ...
        It is okay to go over the user's specified maximum driving hours per day by 25%. Do not get fixated on hitting the exact number.
